...
namespace DeleteContact
{
    ...
    public class Details
    {
        ...
        //deleting contact of particular first name
        public void DeleteContact(string fname)
        {
            foreach (var data in p)
            {
                ...
                {
                    Console.WriteLine("No Such Contact Found Of Name:"+ fname);
                    break;
                }
            }
        }
    }
    public class ABS_Using_C4
    {
        static void Main(string[] args)
        {
            ...
            //Displaying Details
            details.Display();
            Console.Write("Enter The First Name Of The Contact You Have To Delete:");
            string fname=Console.ReadLine();
            details.DeleteContact(fname);
            Console.WriteLine("-----------------Contact Details Are-----------------");
            details.Display();
        }
    }
