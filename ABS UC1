...
namespace CreateContact
{
    ...
    public class Details
    {
        ...
        public void CreateContact(string firstname, string lastname, string address, string city, string state, int zipcode, long mobnum)
        {
    ...
    public class ABS_Using_C1
    {
        static void Main(string[] args)
        {
            ...
            for (int i = 1; i <= n; i++)
            {
                ...
                //Adding Details
                details.CreateContact(firstname, lastname, address, city, state, zipcode, mobnum);
